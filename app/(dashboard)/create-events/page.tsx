...
const mockEvents = [
  {
    ...
    description:
      "Join us for a day of tree planting in the local park to help combat climate change.",
    date: "2025-02-15",
    time: "09:00 AM",
  ...
  },
  {
    ...
    description:
      "Help us clean our local beaches and protect marine life from plastic pollution.",
    date: "2025-01-20",
    time: "08:00 AM",
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Define all details for your upcoming event to engage the community
            in climate action
          </CardDescription>
        </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("detailedAgenda", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("equipmentToBring", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
