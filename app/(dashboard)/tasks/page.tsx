...
export default function TasksPage() {
  const [tasks] = useState<Task[]>(mockTasks.filter((task) => task.organizationId === "org1"))
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              {task.status === "pending" && <DropdownMenuItem>Edit Task</DropdownMenuItem>}
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Create and manage climate tasks for your organization</p>
        </div>
        <Button asChild>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Your Organization's Tasks</CardTitle>
          <CardDescription>Manage tasks created by your organization</CardDescription>
        </CardHeader>
        <CardContent>
